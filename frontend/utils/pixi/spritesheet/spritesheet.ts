...
import { collabDecorSpriteSheetData } from "./collabDecor";
import { collabPeopleSpriteSheetData } from "./collabPeople";
...
import { interiorsSpriteSheetData } from "./interiors";
import { roomBuilderSpriteSheetData } from "./roomBuilder";
import { elevatorSpriteSheetData } from "./elevator";
import { waSpriteSheetDataSet } from "./wa";
...
class Sprites {
  public spriteSheetDataSet: { [key in SheetName]: SpriteSheetData } = {
    ...
    collabDecor: collabDecorSpriteSheetData,
    collabPeople: collabPeopleSpriteSheetData,
    interiors: interiorsSpriteSheetData,
    roomBuilder: roomBuilderSpriteSheetData,
    elevator: elevatorSpriteSheetData,
    waSpecialZones: waSpriteSheetDataSet.waSpecialZones,
    waDecoration: waSpriteSheetDataSet.waDecoration,
    waMiscellaneous: waSpriteSheetDataSet.waMiscellaneous,
    waOtherFurniture: waSpriteSheetDataSet.waOtherFurniture,
    waRoomBuilder: waSpriteSheetDataSet.waRoomBuilder,
    waSeats: waSpriteSheetDataSet.waSeats,
    waTables: waSpriteSheetDataSet.waTables,
    waLogoLong: waSpriteSheetDataSet.waLogoLong,
    waExterior: waSpriteSheetDataSet.waExterior,
    waUserInterface: waSpriteSheetDataSet.waUserInterface,
  };

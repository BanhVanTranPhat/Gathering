...
import DashboardShell from "@/app/app/DashboardShell";
...
type DashboardTab = "overview" | "rooms" | "events" | "community" | "profile";
...
export async function getDashboardPage(initialTab?: DashboardTab) {
  ...
  const { data: profile } = await auth
    .from("profiles")
    .select("avatar, displayName, gender")
    .single();
